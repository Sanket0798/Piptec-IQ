...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-canvas">
      ...
      <button className="group fixed bottom-6 right-6 z-30 flex items-center gap-2 rounded-full card-gradient py-3 pl-4 pr-5 text-sm font-semibold text-white shadow-[0_16px_36px_-12px_rgba(22,55,79,0.6)] transition hover:scale-[1.03]">
